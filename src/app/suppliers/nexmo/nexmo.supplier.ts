...
export class NexmoSupplier implements SmsSupplier {
  ...
  assignNumber(webhook: string): Promise<string> {
    return new Promise((res, rej) => {
      Request.get('https://rest.nexmo.com/number/search', {
        api_key: Config.nexmo.key,
        ...
        .then(result => {
          ...
          Request.post('https://rest.nexmo.com/number/buy', {
            api_key: Config.nexmo.key,
            api_secret: Config.nexmo.secret,
            country: 'GB',
            msisdn: chosenNumber,
            ...
            .then(result => {
              Request.post('https://rest.nexmo.com/number/update', {
                api_key: Config.nexmo.key,
                api_secret: Config.nexmo.secret,
                country: 'GB',
                msisdn: chosenNumber,
